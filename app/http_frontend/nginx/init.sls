...
create_http_frontend_{{ settings.ssl_invalid_target }}:
  file.managed:
    - source: salt://app/http_frontend/nginx/status.template.html
...
/etc/nginx/proxy_params:
  file.managed:
    - source: salt://app/http_frontend/nginx/proxy_params
    - template: jinja
    - defaults:
        settings: {{ settings }}
    - makedirs: true
...
/etc/nginx/uwsgi_params:
  file.managed:
    - source: salt://app/http_frontend/nginx/uwsgi_params
    - template: jinja
    - defaults:
        settings: {{ settings }}
    - makedirs: true
...
/etc/nginx/nginx.conf:
  file.managed:
    - source: salt://app/http_frontend/nginx/nginx.conf
    - template: jinja
    - defaults:
        settings: {{ settings }}
    - makedirs: true
