...
# in general, on modern linux kernels with a psi controlled oom daemon,
# swap mitigates peak load under some cirumstances while using KVM or
# other virtualization: swappiness=1 may be desired.
# rationale: memory is given to the other domains,
# so we dont want the host to swap guest memory
