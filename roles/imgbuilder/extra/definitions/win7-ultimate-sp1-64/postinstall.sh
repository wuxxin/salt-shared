...
cd /home/vagrant/.ssh
cp /cygdrive/a/vagrant_keys.pub authorized_keys
...
wget http://www.spice-space.org/download/windows/spice-guest-tools/spice-guest-tools-0.52.exe
chmod +x spice-guest-tools-0.52.exe
./spice-guest-tools-0.52.exe /S
...
install_salt_minion(){
wget http://saltstack.com/downloads/Salt-Minion-0.13.3-AMD64-Setup.exe
chmod +x Salt-Minion-0.13.3-Setup-amd64.exe
./Salt-Minion-0.13.3-Setup-amd64.exe /S /master=salt /minion-name=win7-64
}
